# 👁️ ObservoAI — Barclays Hack-o-Hire 2025 Project - The AI-Powered API Watchdog
...
- **Grafana (The Control Room Logs, Metrics, Traces)**: [http://localhost:3005](http://localhost:3005) (User: `admin`, Pass: `admin`)
